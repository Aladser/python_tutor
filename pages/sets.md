...
* `discard` и `remove` - удаление элемента x из множества;

* `discard` и `remove` - удаление элемента x из множества. Генерирует исключение KeyError, если элемент остустувует;
